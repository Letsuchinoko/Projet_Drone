...
def main():
    ...
    # --- Démarrage du flux vidéo, PAS DroneVision ---
    bebop.start_video_stream()
    logger.info("Flux vidéo demandé au drone (start_video_stream).")
    time.sleep(2)

    # --- Contrôle drone en thread (optionnel) ---
    ...
    window_name = "Bebop 2 - Détection Gant Bicolore (RAM)"
